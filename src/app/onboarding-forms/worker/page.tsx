// src/app/onboarding-forms/worker/page.tsx
...
export default function WorkerOnboardingFormPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Worker Onboarding Data:", formData);
    setSubmitted(true);
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 py-16 px-6">
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-xl transform transition-all hover:scale-105 duration-300">
        <h2 className="text-2xl font-semibold mb-6 text-[#038167] text-center">Worker Onboarding</h2>
