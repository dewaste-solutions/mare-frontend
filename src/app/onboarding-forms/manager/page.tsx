// src/app/onboarding-forms/manager/page.tsx
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 py-16 px-6">
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-xl transform transition-all hover:scale-105 duration-300">
        <h2 className="text-2xl font-semibold mb-6 text-[#038167] text-center">Manager Onboarding</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <Label htmlFor="team" className="text-lg">Team</Label>
            <Input
              type="text"
              name="team"
              value={formData.team}
