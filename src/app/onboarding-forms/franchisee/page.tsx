// src/app/onboarding-forms/franchisee/page.tsx
...
export default function FranchiseeOnboardingFormPage() {
  const [formData, setFormData] = useState({ franchiseLocation: "", businessType: "" });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Franchisee Onboarding Data:", formData);
    setSubmitted(true);
  };
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 py-16 px-6">
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-xl transform transition-all hover:scale-105 duration-300">
        <h2 className="text-2xl font-semibold mb-6 text-[#038167] text-center">Franchisee Onboarding</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Label htmlFor="franchiseLocation" className="text-lg">Franchise Location</Label>
            <Input
              type="text"
          ...
          <div>
            <Label htmlFor="businessType" className="text-lg">Business Type</Label>
            <Input
              type="text"
              name="businessType"
