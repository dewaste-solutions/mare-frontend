		...
		<div className="space-y-4">
			...
			<div className="overflow-x-auto rounded-lg border">
				<Table className="min-w-[720px]">
					<TableHeader className="bg-muted/50 text-muted-foreground [&_tr]:border-b">
						<TableRow>
			...
			{/* footer */}
			<div className="flex flex-col items-center gap-2 pt-2 text-muted-foreground text-sm sm:flex-row sm:justify-between">
